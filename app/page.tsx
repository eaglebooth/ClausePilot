...
export default function Home(){return <main>
  <header><Link className="brand" href="/"><span><Radar/></span>ClausePilot</Link><nav><a href="#primitive">Primitive</a><a href="#safety">Safety</a><Link href="/monitor">Monitor</Link></nav><Link className="outline" href="/monitor">Open console</Link></header>
  ...
  <footer><div className="brand"><span><Radar/></span>ClausePilot</div><p>Public evidence monitoring. Not legal advice or an automated damages engine.</p><Link href="/monitor">Monitor obligations →</Link></footer>
  </main>}
